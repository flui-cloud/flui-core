...
const ARGS: Record<string, Record<string, unknown>> = {
  ...
  dns_acme_resolvers_pin: { clusterId: 'c1' },
  ...
  gateway_route_sync: { id: 'a1', endpointId: 'e1' },
  mail_readiness: {},
  mail_events: {},
  mail_suppressions: {},
  ...
  app_resource_proposal: { id: 'a1' },
  app_resource_proposal_apply: { id: 'a1' },
  app_resource_proposal_defer: { id: 'a1' },
  app_maintenance: { id: 'a1' },
  app_maintenance_set: { id: 'a1', mode: 'follow' },
  app_deferred_cancel: { id: 'a1', actionId: 'd1' },
  cluster_maintenance: { clusterId: 'c1' },
  cluster_maintenance_set: {
    clusterId: 'c1',
    timezone: 'UTC',
    slots: [{ days: ['tue'], start: '02:00', durationMinutes: 120 }],
  },
  cluster_maintenance_clear: { clusterId: 'c1' },
  app_reconcile: { id: 'a1' },
  app_metrics: { id: 'a1' },
  ...
  scaling_approve_purchase: { groupId: 'g1', shape: 'cpx22', region: 'fsn1' },
